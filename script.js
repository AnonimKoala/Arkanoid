...
class Ball {
        ...
        constructor(pos, dir, size) {
                ...
                this.speed = 20; //Szybkość z jaką porusza się piłka
...
class Brick {
        ...
        constructor(pos, size, type) {
                ...
                if (this.type == 0) {
                        ...
                        this.texture.src = "img/bricks/scaled/orangeBrick.png"
                        this.value = 60
                }
                else if (this.type == 2) {
                        this.texture.src = "img/bricks/scaled/cyanBrick.png";
                        this.value = 70
                }
                else if (this.type == 3) {
                        this.texture.src = "img/bricks/scaled/greenBrick.png"
                        this.value = 80
                }
                else if (this.type == 4) {
                        this.texture.src = "img/bricks/scaled/redBrick.png"
                        this.value = 90
                }
                else if (this.type == 5) {
                        this.texture.src = "img/bricks/scaled/blueBrick.png"
                        this.value = 100
                }
                else if (this.type == 6) {
                        this.texture.src = "img/bricks/scaled/pinkBrick.png"
                        this.value = 110
                }
                else if (this.type == 7) {
                        this.texture.src = "img/bricks/scaled/yellowBrick.png"
                        this.value = 120
                }
                else if (this.type == 8) {
                        this.texture.src = "img/bricks/scaled/silverBrick.jpg"
                        this.value = 50 * playerLevel
                        this.health = parseInt(playerLevel / 8) + 2
                }
                else if (this.type == 9) {
                        this.texture.src = "img/bricks/scaled/goldBrick.jpg"
                        this.health = -1
                }
...
function gameLoop(cTime) {
        if (gameStarted && !gamePaused && !gameOvered) {
                ...
                if (!Brick.list.length) // Dodać regułę na gold bricki
                        nextLevel()
